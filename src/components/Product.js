  ...
  render() {
    ...
    return (
      <ProductWrapper className="col-9 mx-auto col-md-6 col-lg-3 my-3">
            <div className="card">
            <div className="img-container p-5" onClick={()=>this.props.onGetProductDetails(id)}>
            <Link to="/details">
...
const mapDispachToProps = dispatch => {
  return {
    onGetProductDetails: (id) => dispatch({ type: "GET_PRODUCT_DETAILS", value: id }),
